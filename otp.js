!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.otplib = t() : e.otplib = t()
}(window, (function () {
    return function (e) {
        var t = {};
        ...
        e.exports = (r = r || function (e, t) {
            var n = Object.create || function () {
                ...
                reset: function () {
                    ...
                    var n = this._data, r = n.words, o = n.sigBytes, i = this.blockSize, u = o / (4 * i),
                        a = (u = t ? e.ceil(u) : e.max((0 | u) - this._minBufferSize, 0)) * i, s = e.min(4 * a, o);
                    if (a) {
        ...
        var r, o, i, c;
        e.exports = (r = n(0), i = (o = r).lib.Base, c = o.enc.Utf8, void (o.algo.HMAC = i.extend({
            init: function (e, t) {
                e = this._hasher = new e.init, "string" == typeof t && (t = c.parse(t));
                var n = e.blockSize, r = 4 * n;
                t.sigBytes > r && (t = e.finalize(t)), t.clamp();
                for (var o = this._oKey = t.clone(), i = this._iKey = t.clone(), u = o.words, a = i.words, s = 0; s < n; s++) u[s] ^= 1549556828, a[s] ^= 909522486;
        ...
        var r, o, i, c, u, a;
        e.exports = (a = n(0), o = (r = a).lib, i = o.Base, c = o.WordArray, (u = r.x64 = {}).Word = i.extend({
            init: function (e, t) {
        ...
        e.exports = function (e, t) {
            ...
            switch (t) {
                ...
                case"RFC4648-HEX":
                    ...
                    break;
                case"Crockford":
                    r = "0123456789ABCDEFGHJKMNPQRSTVWXYZ", e = e.toUpperCase().replace(/O/g, "0").replace(/[IL]/g, "1");
                    break;
                default:
                    throw new Error("Unknown base32 variant: " + t)
            }
            for (var o = e.length, i = 0, c = 0, u = 0, a = new Uint8Array(5 * o / 8 | 0), s = 0; s < o; s++) c = c << 5 | n(r, e[s]), (i += 5) >= 8 && (a[u++] = c >>> i - 8 & 255, i -= 8);
            return a.buffer
        }
    }, function (e, t) {
        e.exports = function (e, t, n) {
            ...
            for (var i = void 0 !== n.padding ? n.padding : o, c = e.byteLength, u = new Uint8Array(e), a = 0, s = 0, f = "", l = 0; l < c; l++) for (s = s << 8 | u[l], a += 8; a >= 5;) f += r[s >>> a - 5 & 31], a -= 5;
            if (a > 0 && (f += r[s << 5 - a & 31]), i) for (; f.length % 8 != 0;) f += "=";
            return f
        }
    }, function (e, t, n) {
        var r, o, i, c, u, a, s, f;
        e.exports = (f = n(0), o = (r = f).lib, i = o.WordArray, c = o.Hasher, u = r.algo, a = [], s = u.SHA1 = c.extend({
            _doReset: function () {
                this._hash = new i.init([1732584193, 4023233417, 2562383102, 271733878, 3285377520])
            }, _doProcessBlock: function (e, t) {
                for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], c = n[3], u = n[4], s = 0; s < 80; s++) {
                    if (s < 16) a[s] = 0 | e[t + s]; else {
        ...
        }), r.SHA1 = c._createHelper(s), r.HmacSHA1 = c._createHmacHelper(s), f.SHA1)
    }, function (e, t, n) {
        var r;
        e.exports = (r = n(0), function (e) {
            var t = r, n = t.lib, o = n.WordArray, i = n.Hasher, c = t.algo, u = [], a = [];
            !function () {
                function t(t) {
                ...
                for (var r = 2, o = 0; o < 64;) t(r) && (o < 8 && (u[o] = n(e.pow(r, .5))), a[o] = n(e.pow(r, 1 / 3)), o++), r++
            }();
            var s = [], f = c.SHA256 = i.extend({
                _doReset: function () {
                    this._hash = new o.init(u.slice(0))
                }, _doProcessBlock: function (e, t) {
                    for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], c = n[3], u = n[4], f = n[5], l = n[6], p = n[7], h = 0; h < 64; h++) {
                        if (h < 16) s[h] = 0 | e[t + h]; else {
                            var y = s[h - 15], b = (y << 25 | y >>> 7) ^ (y << 14 | y >>> 18) ^ y >>> 3, g = s[h - 2],
                                d = (g << 15 | g >>> 17) ^ (g << 13 | g >>> 19) ^ g >>> 10;
                            s[h] = b + s[h - 7] + d + s[h - 16]
                        }
                        var v = r & o ^ r & i ^ o & i,
                            w = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22),
                            m = p + ((u << 26 | u >>> 6) ^ (u << 21 | u >>> 11) ^ (u << 7 | u >>> 25)) + (u & f ^ ~u & l) + a[h] + s[h];
                        p = l, l = f, f = u, u = c + m | 0, c = i, i = o, o = r, r = m + (w + v) | 0
                    }
                    n[0] = n[0] + r | 0, n[1] = n[1] + o | 0, n[2] = n[2] + i | 0, n[3] = n[3] + c | 0, n[4] = n[4] + u | 0, n[5] = n[5] + f | 0, n[6] = n[6] + l | 0, n[7] = n[7] + p | 0
                }, _doFinalize: function () {
        ...
        var r;
        e.exports = (r = n(0), n(3), function () {
            var e = r, t = e.lib.Hasher, n = e.x64, o = n.Word, i = n.WordArray, c = e.algo;
            ...
            var f = c.SHA512 = t.extend({
                _doReset: function () {
                    ...
                    for (var n = this._hash.words, r = n[0], o = n[1], i = n[2], c = n[3], u = n[4], f = n[5], l = n[6], p = n[7], h = r.high, y = r.low, b = o.high, g = o.low, d = i.high, v = i.low, w = c.high, m = c.low, O = u.high, j = u.low, _ = f.high, S = f.low, P = l.high, k = l.low, x = p.high, E = p.low, H = h, A = y, B = b, D = g, C = d, R = v, z = w, T = m, M = O, I = j, U = _, F = S, K = P, N = k, W = x, X = E, L = 0; L < 80; L++) {
                        var G = s[L];
                        if (L < 16) var J = G.high = 0 | e[t + 2 * L], Q = G.low = 0 | e[t + 2 * L + 1]; else {
                            var V = s[L - 15], $ = V.high, Y = V.low,
                                Z = ($ >>> 1 | Y << 31) ^ ($ >>> 8 | Y << 24) ^ $ >>> 7,
                                q = (Y >>> 1 | $ << 31) ^ (Y >>> 8 | $ << 24) ^ (Y >>> 7 | $ << 25), ee = s[L - 2],
                                te = ee.high, ne = ee.low,
                                re = (te >>> 19 | ne << 13) ^ (te << 3 | ne >>> 29) ^ te >>> 6,
                                oe = (ne >>> 19 | te << 13) ^ (ne << 3 | te >>> 29) ^ (ne >>> 6 | te << 26),
                                ie = s[L - 7], ce = ie.high, ue = ie.low, ae = s[L - 16], se = ae.high, fe = ae.low;
                            J = (J = (J = Z + ce + ((Q = q + ue) >>> 0 < q >>> 0 ? 1 : 0)) + re + ((Q += oe) >>> 0 < oe >>> 0 ? 1 : 0)) + se + ((Q += fe) >>> 0 < fe >>> 0 ? 1 : 0), G.high = J, G.low = Q
                        }
                        var le, pe = M & U ^ ~M & K, he = I & F ^ ~I & N, ye = H & B ^ H & C ^ B & C,
                            be = A & D ^ A & R ^ D & R,
                            ge = (H >>> 28 | A << 4) ^ (H << 30 | A >>> 2) ^ (H << 25 | A >>> 7),
                            de = (A >>> 28 | H << 4) ^ (A << 30 | H >>> 2) ^ (A << 25 | H >>> 7),
                            ve = (M >>> 14 | I << 18) ^ (M >>> 18 | I << 14) ^ (M << 23 | I >>> 9),
                            we = (I >>> 14 | M << 18) ^ (I >>> 18 | M << 14) ^ (I << 23 | M >>> 9), me = a[L],
                            Oe = me.high, je = me.low, _e = W + ve + ((le = X + we) >>> 0 < X >>> 0 ? 1 : 0),
                            Se = de + be;
                        W = K, X = N, K = U, N = F, U = M, F = I, M = z + (_e = (_e = (_e = _e + pe + ((le += he) >>> 0 < he >>> 0 ? 1 : 0)) + Oe + ((le += je) >>> 0 < je >>> 0 ? 1 : 0)) + J + ((le += Q) >>> 0 < Q >>> 0 ? 1 : 0)) + ((I = T + le | 0) >>> 0 < T >>> 0 ? 1 : 0) | 0, z = C, T = R, C = B, R = D, B = H, D = A, H = _e + (ge + ye + (Se >>> 0 < de >>> 0 ? 1 : 0)) + ((A = le + Se | 0) >>> 0 < le >>> 0 ? 1 : 0) | 0
                    }
                    y = r.low = y + A, r.high = h + H + (y >>> 0 < A >>> 0 ? 1 : 0), g = o.low = g + D, o.high = b + B + (g >>> 0 < D >>> 0 ? 1 : 0), v = i.low = v + R, i.high = d + C + (v >>> 0 < R >>> 0 ? 1 : 0), m = c.low = m + T, c.high = w + z + (m >>> 0 < T >>> 0 ? 1 : 0), j = u.low = j + I, u.high = O + M + (j >>> 0 < I >>> 0 ? 1 : 0), S = f.low = S + F, f.high = _ + U + (S >>> 0 < F >>> 0 ? 1 : 0), k = l.low = k + N, l.high = P + K + (k >>> 0 < N >>> 0 ? 1 : 0), E = p.low = E + X, p.high = x + W + (E >>> 0 < X >>> 0 ? 1 : 0)
                }, _doFinalize: function () {
                    var e = this._data, t = e.words, n = 8 * this._nDataBytes, r = 8 * e.sigBytes;
        ...
        "use strict";
        n.r(t);
        var r, o = n(0), i = n.n(o), c = n(4), u = n.n(c), a = n(5), s = n.n(a), f = n(6), l = n.n(f), p = n(2),
            h = n.n(p);
        ...
        var w, m = v(r);
        !function (e) {
            e.ASCII = "ascii", e.BASE64 = "base64", e.HEX = "hex", e.LATIN1 = "latin1", e.UTF8 = "utf8"
        }(w || (w = {}));
        var O, j = v(w);
        !function (e) {
            e.HOTP = "hotp", e.TOTP = "totp"
        }(O || (O = {}));
        var _ = v(O), S = function () {
        ...
        function k(e, t, n) {
            ...
            return "".concat(r).concat(e).slice(-1 * t)
        }

        function x(e) {
            var t = "otpauth://".concat(e.type, "/{labelPrefix}:{accountName}?secret={secret}{query}"), n = [];
            if (_.indexOf(e.type) < 0) throw new Error("Expecting options.type to be one of ".concat(_.join(", "), ". Received ").concat(e.type, "."));
            if ("hotp" === e.type) {
                if (null == e.counter || "number" != typeof e.counter) throw new Error('Expecting options.counter to be a number when options.type is "hotp".');
                n.push("&counter=".concat(e.counter))
            }
            return "totp" === e.type && e.step && n.push("&period=".concat(e.step)), e.digits && n.push("&digits=".concat(e.digits)), e.algorithm && n.push("&algorithm=".concat(e.algorithm.toUpperCase())), e.issuer && n.push("&issuer=".concat(encodeURIComponent(e.issuer))), t.replace("{labelPrefix}", encodeURIComponent(e.issuer || e.accountName)).replace("{accountName}", encodeURIComponent(e.accountName)).replace("{secret}", e.secret).replace("{query}", n.join(""))
        }
        ...
        function z(e) {
            if ("function" != typeof e.createDigest) throw new Error("Expecting options.createDigest to be a function.");
            if ("function" != typeof e.createHmacKey) throw new Error("Expecting options.createHmacKey to be a function.");
            if ("number" != typeof e.digits) throw new Error("Expecting options.digits to be a number.");
            if (!e.algorithm || m.indexOf(e.algorithm) < 0) throw new Error("Expecting options.algorithm to be one of ".concat(m.join(", "), ". Received ").concat(e.algorithm, "."));
            if (!e.encoding || j.indexOf(e.encoding) < 0) throw new Error("Expecting options.encoding to be one of ".concat(j.join(", "), ". Received ").concat(e.encoding, "."))
        }
        ...
        function M(e) {
            var t = function (e) {
                ...
                return e
            }({}, {algorithm: r.SHA1, createHmacKey: T, createDigest: S, digits: 6, encoding: w.ASCII}, {}, e);
        ...
        function I(e, t, n) {
            ...
            }(t), o = n.createHmacKey(n.algorithm, e, n.encoding);
            return n.createDigest(n.algorithm, o, r)
        }

        function U(e, t, n) {
            return function (e, t) {
                var n = Buffer.from(e, "hex"), r = 15 & n[n.length - 1],
                    o = ((127 & n[r]) << 24 | (255 & n[r + 1]) << 16 | (255 & n[r + 2]) << 8 | 255 & n[r + 3]) % Math.pow(10, t);
        ...
        var K = function (e) {
            function t() {
                ...
                }(this, t), A(this, B(t).apply(this, arguments))
            }
            ...
            return function (e, t) {
                ...
                key: "generate", value: function (e, t) {
                ...
                key: "verify", value: function (e) {
                    if ("object" !== E(e)) throw new Error("Expecting argument 0 of verify to be an object");
                    return this.check(e.token, e.secret, e.counter)
                }
            }, {
                key: "keyuri", value: function (e, t, n, r) {
            ...
            function e() {
                ...
                !function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this._defaultOptions = Object.freeze(b({}, t)), this._options = Object.freeze({})
            }
        ...
        function Z(e) {
            if (z(e), Y(e.window), "number" != typeof e.epoch) throw new Error("Expecting options.epoch to be a number.");
            if ("number" != typeof e.step) throw new Error("Expecting options.step to be a number.")
        }

        var q = function (e, t, n) {
            var r = e.length, o = Buffer.from(e, t).toString("hex");
            if (r < n) {
            ...
            switch (e) {
                ...
                case r.SHA512:
                    return q(t, n, 64);
                default:
                    throw new Error("Expecting algorithm to be one of ".concat(m.join(", "), ". Received ").concat(e, "."))
            }
        };
        ...
        function ce(e, t, n) {
            ...
            var r, o, i, c, u, a = (r = n.epoch, o = n.step, i = n.window, c = Y(i), {
                current: r,
                past: re(r, -1, u = 1e3 * o, c[0]),
                future: re(r, 1, u, c[1])
            }), s = ie(a.past, e, t, n);
        ...
        var se = function (e) {
            function t() {
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t), X(this, L(t).apply(this, arguments))
            }
            ...
            return function (e, t) {
                ...
                key: "checkDelta", value: function (e, t) {
                ...
                key: "verify", value: function (e) {
                    if ("object" !== N(e)) throw new Error("Expecting argument 0 of verify to be an object");
                    return this.check(e.token, e.secret)
                }
            }, {
                key: "timeRemaining", value: function () {
                    var e, t, n = this.allOptions();
                ...
                key: "keyuri", value: function (e, t, n) {
        ...
        function de(e) {
            ...
            return function (e) {
                if (Z(e), "function" != typeof e.keyDecoder) throw new Error("Expecting options.keyDecoder to be a function.");
        ...
        var Oe = function (e) {
            function t() {
                return function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t), pe(this, he(t).apply(this, arguments))
            }
            ...
            var o = function (e) {
                switch (e) {
                    ...
                    case r.SHA512:
                        return l.a;
                    default:
                        throw new Error("Expecting argument 0 to be one of ".concat(m.join(", "), ". Received ").concat(e, "."))
                }
            }(e), i = h.a.parse(n), c = h.a.parse(t);
            return String(o(i, c))
        }, Se = n(7), Pe = n.n(Se), ke = n(8), xe = n.n(ke);
        ...
        n.d(t, "hotp", (function () {
            ...
            return Be
        })), "object" === ("undefined" == typeof window ? "undefined" : Ee(window)) && void 0 === window.Buffer && (window.Buffer = buffer.Buffer);
        var He = new K({createDigest: _e}), Ae = new se({createDigest: _e}), Be = new Oe({
            createDigest: _e, createRandomBytes: function (e, t) {
                var n = je.random(e);
